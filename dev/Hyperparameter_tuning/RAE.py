...
import geoad.nn.recurrent_autoencoder as rae
...
def main(args):
    ...
    def objective(trial):
        ...
        n_features=1
        rnn_type = args.rnn_type #'GRU', 'RNN', 'LSTM'
        rnn_act = args.rnn_act #'relu'
        ...
        model = rae.RecurrentAE(n_features, latent_dim, rnn_type, rnn_act, device)                       
    ...
    if args.log_mod == '':
        log_file = args.log_dir + args.model + args.rnn_type + '_' + str(args.graph_clusters) + '.pkl'
    else:
        log_file = args.log_dir + args.model + args.rnn_type + '_' + str(args.graph_clusters)+'_'+ args.log_mod+'.pkl'
...
if __name__ == "__main__":
    ...
    for n_clusters in [30, 20, 10, 5, 2]:
        ...
        parser.add_argument('--model', type=str, default='RAE')
        ...
        parser.add_argument('--N_epochs', type=int, nargs='+', default=[50, 100, 250, 200, 500, 1000, 5000])
        parser.add_argument('--latent_dim', type=int, nargs='+', default=[2, 3, 4, 5, 6])
        ...
        parser.add_argument('--rnn_act', type=str, default='relu')
